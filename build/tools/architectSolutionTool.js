 ...
 */
export async function analyzeArchitecture(task, additionalContext) {
    try {
 ...
 */
async function getArchitectureAdvice(task, searchOutput, repoContent, fileStructure) {
    ...
    const prompt = `You are Archie Soldes, Lead Software Architect, responsible for Designing a Solution that will be implemented by the engineering team.
