...
server.tool(
  "query-codebase",
  "Gathers relevant code from the codebase based on a query, returning the raw code dump output. Can handle multiple queries in a single tool call.",
  { query: z.string().describe("Provide specific details about what code you're looking for to help narrow down the search. Include all queries and objective in natural language.") },
  async ({ query }) => {
    try {
